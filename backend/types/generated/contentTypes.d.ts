...
export interface ApiCustomRoleCustomRole extends Schema.CollectionType {
...
export interface ApiNetworkConfigNetworkConfig extends Schema.SingleType {
  collectionName: 'network_configs';
  info: {
    singularName: 'network-config';
    pluralName: 'network-configs';
  ...
  attributes: {
    ...
    roleCustomization: Attribute.Component<'network.role-customization', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::network-config.network-config',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNodeNode extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nodeClarification: Attribute.Component<'network.node-clarification', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    overrides: Attribute.Component<'network.node-overrides', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    nodeClarificationHeading: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    node_dimensions: Attribute.Relation<
      'api::node.node',
      'manyToMany',
      'api::node-dimension.node-dimension'
    >;
    type: Attribute.Enumeration<['positive']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNodeDimensionNodeDimension extends Schema.CollectionType {
  collectionName: 'node_dimensions';
  info: {
    singularName: 'node-dimension';
    pluralName: 'node-dimensions';
    displayName: 'Node Dimension';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    sliderColor: Attribute.Enumeration<['green', 'red']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::network-config.network-config': ApiNetworkConfigNetworkConfig;
      'api::node.node': ApiNodeNode;
      'api::node-dimension.node-dimension': ApiNodeDimensionNodeDimension;
