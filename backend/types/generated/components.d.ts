...
export interface ElementsOnboardingStep extends Schema.Component {
  ...
  attributes: {
    ...
    placement: Attribute.Enumeration<['bottom', 'center', 'left-start']>;
...
export interface NetworkBuilderOnboarding extends Schema.Component {
  ...
  attributes: {
    ...
    nodeSelectPositive: Attribute.Component<'elements.onboarding-step'>;
    linkRankingPositive: Attribute.Component<'elements.onboarding-step'>;
